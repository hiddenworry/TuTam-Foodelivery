...
{
    public class DeliveryRequestsForDonatedRequestToBranchCreatingRequestValidator
        : AbstractValidator<DeliveryRequestsForDonatedRequestToBranchCreatingRequest>
    {
        public DeliveryRequestsForDonatedRequestToBranchCreatingRequestValidator()
        {
            RuleFor(ar => ar.Note)
            ...
            RuleFor(ar => ar.DonatedRequestId)
                .NotNull()
                .WithMessage("Id yêu cầu quyên góp không được trống.");
