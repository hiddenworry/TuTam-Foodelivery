...
{
    public class DeliveryRequestsForBranchToBranchCreatingRequestValidator
        : AbstractValidator<DeliveryRequestsForBranchToBranchCreatingRequest>
    {
        public DeliveryRequestsForBranchToBranchCreatingRequestValidator()
        {
            RuleFor(ar => ar.Note)
